...
def calculate_rss(observed: np.ndarray, calculated: np.ndarray) -> float:
...
def calculate_r_squared(observed: np.ndarray, calculated: np.ndarray) -> float:
...
def generate_quality_report(
    ...
    # Validate parameters
    is_valid, param_warnings = validate_fit_parameters(center, amplitude, fwhm, eta)
